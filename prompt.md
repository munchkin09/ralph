...
1. Read the PRD at `prd|ralph_stories.json` (in the same directory as this file)
...
12. Update outline document `PROJECT->TASKS->[Story ID]` with same content as progress.txt
